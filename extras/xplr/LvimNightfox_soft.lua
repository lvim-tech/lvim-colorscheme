...
function M.setup()
    ...
    c.focus_ui.style = { fg = { Rgb = { 23, 31, 43 } }, bg = { Rgb = { 114, 146, 189 } }, add_modifiers = { "Bold" } }
    c.selection_ui.style = { fg = { Rgb = { 137, 170, 154 } }, add_modifiers = { "Bold" } }
    c.focus_selection_ui.style = { fg = { Rgb = { 23, 31, 43 } }, bg = { Rgb = { 137, 170, 154 } } , add_modifiers = { "Bold" } }
    c.table.header.style = { fg = { Rgb = { 117, 130, 146 } }, add_modifiers = { "Bold" } }
    c.table.row.style.fg = { Rgb = { 188, 189, 189 } }
    c.table.tree[1].style.fg = { Rgb = { 45, 62, 86 } }
    c.table.tree[2].style.fg = { Rgb = { 45, 62, 86 } }
    c.table.tree[3].style.fg = { Rgb = { 45, 62, 86 } }
