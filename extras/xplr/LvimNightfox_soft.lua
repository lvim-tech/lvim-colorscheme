...
function M.setup()
    ...
    c.prompt.style.fg = { Rgb = { 157, 131, 176 } }
    c.cursor.style.fg = { Rgb = { 110, 144, 189 } }
    c.default_ui.style.fg = { Rgb = { 188, 189, 189 } }
    c.focus_ui.style = { fg = { Rgb = { 25, 36, 51 } }, bg = { Rgb = { 108, 141, 185 } }, add_modifiers = { "Bold" } }
    ...
    c.table.header.style = { fg = { Rgb = { 128, 143, 162 } }, add_modifiers = { "Bold" } }
    ...
    c.logs.info.style.fg = { Rgb = { 110, 144, 189 } }
    c.logs.success.style.fg = { Rgb = { 123, 153, 138 } }
    c.logs.warning.style.fg = { Rgb = { 187, 167, 111 } }
    c.logs.error.style.fg = { Rgb = { 199, 116, 137 } }

    local n = xplr.config.node_types
    n.directory.style = { fg = { Rgb = { 110, 144, 189 } }, add_modifiers = { "Bold" } }
