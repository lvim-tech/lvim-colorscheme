...
function M.setup()
    ...
    c.focus_ui.style = { fg = { Rgb = { 23, 24, 28 } }, bg = { Rgb = { 77, 105, 155 } }, add_modifiers = { "Bold" } }
    c.selection_ui.style = { fg = { Rgb = { 110, 129, 86 } }, add_modifiers = { "Bold" } }
    c.focus_selection_ui.style = { fg = { Rgb = { 23, 24, 28 } }, bg = { Rgb = { 110, 129, 86 } } , add_modifiers = { "Bold" } }
    c.table.header.style = { fg = { Rgb = { 78, 78, 115 } }, add_modifiers = { "Bold" } }
    c.table.row.style.fg = { Rgb = { 84, 84, 109 } }
    c.table.tree[1].style.fg = { Rgb = { 41, 42, 50 } }
    c.table.tree[2].style.fg = { Rgb = { 41, 42, 50 } }
    c.table.tree[3].style.fg = { Rgb = { 41, 42, 50 } }
