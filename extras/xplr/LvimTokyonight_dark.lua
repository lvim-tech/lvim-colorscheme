...
function M.setup()
    ...
    c.focus_ui.style = { fg = { Rgb = { 19, 19, 26 } }, bg = { Rgb = { 101, 137, 215 } }, add_modifiers = { "Bold" } }
    c.selection_ui.style = { fg = { Rgb = { 157, 189, 123 } }, add_modifiers = { "Bold" } }
    c.focus_selection_ui.style = { fg = { Rgb = { 19, 19, 26 } }, bg = { Rgb = { 157, 189, 123 } } , add_modifiers = { "Bold" } }
    c.table.header.style = { fg = { Rgb = { 97, 103, 132 } }, add_modifiers = { "Bold" } }
    c.table.row.style.fg = { Rgb = { 178, 182, 199 } }
    c.table.tree[1].style.fg = { Rgb = { 41, 46, 66 } }
    c.table.tree[2].style.fg = { Rgb = { 41, 46, 66 } }
    c.table.tree[3].style.fg = { Rgb = { 41, 46, 66 } }
