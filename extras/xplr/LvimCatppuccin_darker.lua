...
function M.setup()
    ...
    c.cursor.style.fg = { Rgb = { 103, 131, 181 } }
    ...
    c.focus_selection_ui.style = { fg = { Rgb = { 20, 21, 28 } }, bg = { Rgb = { 107, 141, 105 } } , add_modifiers = { "Bold" } }
    c.table.header.style = { fg = { Rgb = { 120, 128, 161 } }, add_modifiers = { "Bold" } }
    c.table.row.style.fg = { Rgb = { 178, 183, 199 } }
    c.table.tree[1].style.fg = { Rgb = { 28, 29, 36 } }
    c.table.tree[2].style.fg = { Rgb = { 28, 29, 36 } }
    c.table.tree[3].style.fg = { Rgb = { 28, 29, 36 } }
    ...
    c.logs.info.style.fg = { Rgb = { 103, 131, 181 } }
    c.logs.success.style.fg = { Rgb = { 107, 141, 105 } }
    c.logs.warning.style.fg = { Rgb = { 184, 164, 126 } }
    c.logs.error.style.fg = { Rgb = { 187, 103, 124 } }

    local n = xplr.config.node_types
    n.directory.style = { fg = { Rgb = { 103, 131, 181 } }, add_modifiers = { "Bold" } }
