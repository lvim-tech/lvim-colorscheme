...
function M.setup()
    ...
    c.focus_ui.style = { fg = { Rgb = { 20, 26, 29 } }, bg = { Rgb = { 97, 138, 223 } }, add_modifiers = { "Bold" } }
    c.selection_ui.style = { fg = { Rgb = { 166, 201, 116 } }, add_modifiers = { "Bold" } }
    c.focus_selection_ui.style = { fg = { Rgb = { 20, 26, 29 } }, bg = { Rgb = { 166, 201, 116 } } , add_modifiers = { "Bold" } }
    c.table.header.style = { fg = { Rgb = { 94, 106, 112 } }, add_modifiers = { "Bold" } }
    c.table.row.style.fg = { Rgb = { 178, 199, 199 } }
    c.table.tree[1].style.fg = { Rgb = { 43, 56, 62 } }
    c.table.tree[2].style.fg = { Rgb = { 43, 56, 62 } }
    c.table.tree[3].style.fg = { Rgb = { 43, 56, 62 } }
