...
function M.setup()
    ...
    c.focus_ui.style = { fg = { Rgb = { 20, 19, 33 } }, bg = { Rgb = { 65, 109, 127 } }, add_modifiers = { "Bold" } }
    c.selection_ui.style = { fg = { Rgb = { 131, 178, 186 } }, add_modifiers = { "Bold" } }
    c.focus_selection_ui.style = { fg = { Rgb = { 20, 19, 33 } }, bg = { Rgb = { 131, 178, 186 } } , add_modifiers = { "Bold" } }
    c.table.header.style = { fg = { Rgb = { 116, 110, 145 } }, add_modifiers = { "Bold" } }
    c.table.row.style.fg = { Rgb = { 180, 178, 199 } }
    c.table.tree[1].style.fg = { Rgb = { 59, 56, 75 } }
    c.table.tree[2].style.fg = { Rgb = { 59, 56, 75 } }
    c.table.tree[3].style.fg = { Rgb = { 59, 56, 75 } }
