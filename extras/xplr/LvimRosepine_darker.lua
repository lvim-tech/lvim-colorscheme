...
function M.setup()
    ...
    c.cursor.style.fg = { Rgb = { 108, 130, 140 } }
    ...
    c.table.header.style = { fg = { Rgb = { 154, 114, 146 } }, add_modifiers = { "Bold" } }
    ...
    c.logs.info.style.fg = { Rgb = { 108, 130, 140 } }
    ...
    n.directory.style = { fg = { Rgb = { 108, 130, 140 } }, add_modifiers = { "Bold" } }
