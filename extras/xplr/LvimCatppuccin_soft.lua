...
function M.setup()
    ...
    c.focus_ui.style = { fg = { Rgb = { 21, 21, 34 } }, bg = { Rgb = { 103, 147, 218 } }, add_modifiers = { "Bold" } }
    c.selection_ui.style = { fg = { Rgb = { 132, 194, 127 } }, add_modifiers = { "Bold" } }
    c.focus_selection_ui.style = { fg = { Rgb = { 21, 21, 34 } }, bg = { Rgb = { 132, 194, 127 } } , add_modifiers = { "Bold" } }
    c.table.header.style = { fg = { Rgb = { 108, 115, 147 } }, add_modifiers = { "Bold" } }
    c.table.row.style.fg = { Rgb = { 178, 183, 199 } }
    c.table.tree[1].style.fg = { Rgb = { 57, 59, 74 } }
    c.table.tree[2].style.fg = { Rgb = { 57, 59, 74 } }
    c.table.tree[3].style.fg = { Rgb = { 57, 59, 74 } }
