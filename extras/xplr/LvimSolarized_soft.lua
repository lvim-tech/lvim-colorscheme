...
function M.setup()
    ...
    c.focus_ui.style = { fg = { Rgb = { 0, 40, 50 } }, bg = { Rgb = { 67, 134, 181 } }, add_modifiers = { "Bold" } }
    c.selection_ui.style = { fg = { Rgb = { 114, 127, 26 } }, add_modifiers = { "Bold" } }
    c.focus_selection_ui.style = { fg = { Rgb = { 0, 40, 50 } }, bg = { Rgb = { 114, 127, 26 } } , add_modifiers = { "Bold" } }
    c.table.header.style = { fg = { Rgb = { 93, 106, 111 } }, add_modifiers = { "Bold" } }
    c.table.row.style.fg = { Rgb = { 157, 164, 164 } }
    c.table.tree[1].style.fg = { Rgb = { 16, 83, 99 } }
    c.table.tree[2].style.fg = { Rgb = { 16, 83, 99 } }
    c.table.tree[3].style.fg = { Rgb = { 16, 83, 99 } }
