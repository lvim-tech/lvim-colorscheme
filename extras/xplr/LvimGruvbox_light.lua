...
function M.setup()
    ...
    c.cursor.style.fg = { Rgb = { 89, 136, 163 } }
    c.default_ui.style.fg = { Rgb = { 94, 136, 136 } }
    c.focus_ui.style = { fg = { Rgb = { 218, 218, 218 } }, bg = { Rgb = { 89, 136, 163 } }, add_modifiers = { "Bold" } }
    c.selection_ui.style = { fg = { Rgb = { 122, 125, 72 } }, add_modifiers = { "Bold" } }
    c.focus_selection_ui.style = { fg = { Rgb = { 218, 218, 218 } }, bg = { Rgb = { 122, 125, 72 } } , add_modifiers = { "Bold" } }
    c.table.header.style = { fg = { Rgb = { 165, 146, 131 } }, add_modifiers = { "Bold" } }
    ...
    c.panel_ui.selection.style.fg = { Rgb = { 122, 125, 72 } }
    c.panel_ui.sort_and_filter.style.fg = { Rgb = { 143, 129, 86 } }
    c.logs.info.style.fg = { Rgb = { 89, 136, 163 } }
    c.logs.success.style.fg = { Rgb = { 122, 125, 72 } }
    c.logs.warning.style.fg = { Rgb = { 143, 129, 86 } }
    c.logs.error.style.fg = { Rgb = { 199, 78, 78 } }

    local n = xplr.config.node_types
    n.directory.style = { fg = { Rgb = { 89, 136, 163 } }, add_modifiers = { "Bold" } }
