...
function M.setup()
    ...
    c.focus_ui.style = { fg = { Rgb = { 22, 27, 29 } }, bg = { Rgb = { 66, 114, 139 } }, add_modifiers = { "Bold" } }
    c.selection_ui.style = { fg = { Rgb = { 117, 120, 58 } }, add_modifiers = { "Bold" } }
    c.focus_selection_ui.style = { fg = { Rgb = { 22, 27, 29 } }, bg = { Rgb = { 117, 120, 58 } } , add_modifiers = { "Bold" } }
    ...
    c.panel_ui.input_and_logs.style.fg = { Rgb = { 90, 97, 88 } }
