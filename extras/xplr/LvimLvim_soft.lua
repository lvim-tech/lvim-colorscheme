...
function M.setup()
    ...
    c.focus_ui.style = { fg = { Rgb = { 30, 35, 37 } }, bg = { Rgb = { 10, 133, 185 } }, add_modifiers = { "Bold" } }
    c.selection_ui.style = { fg = { Rgb = { 138, 165, 95 } }, add_modifiers = { "Bold" } }
    c.focus_selection_ui.style = { fg = { Rgb = { 30, 35, 37 } }, bg = { Rgb = { 138, 165, 95 } } , add_modifiers = { "Bold" } }
    c.table.header.style = { fg = { Rgb = { 77, 98, 99 } }, add_modifiers = { "Bold" } }
    c.table.row.style.fg = { Rgb = { 94, 136, 136 } }
    c.table.tree[1].style.fg = { Rgb = { 60, 71, 79 } }
    c.table.tree[2].style.fg = { Rgb = { 60, 71, 79 } }
    c.table.tree[3].style.fg = { Rgb = { 60, 71, 79 } }
