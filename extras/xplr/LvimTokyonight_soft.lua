...
function M.setup()
    ...
    c.focus_ui.style = { fg = { Rgb = { 24, 24, 32 } }, bg = { Rgb = { 101, 137, 215 } }, add_modifiers = { "Bold" } }
    c.selection_ui.style = { fg = { Rgb = { 157, 189, 123 } }, add_modifiers = { "Bold" } }
    c.focus_selection_ui.style = { fg = { Rgb = { 24, 24, 32 } }, bg = { Rgb = { 157, 189, 123 } } , add_modifiers = { "Bold" } }
    c.table.header.style = { fg = { Rgb = { 97, 103, 132 } }, add_modifiers = { "Bold" } }
    c.table.row.style.fg = { Rgb = { 178, 182, 199 } }
    c.table.tree[1].style.fg = { Rgb = { 45, 51, 73 } }
    c.table.tree[2].style.fg = { Rgb = { 45, 51, 73 } }
    c.table.tree[3].style.fg = { Rgb = { 45, 51, 73 } }
