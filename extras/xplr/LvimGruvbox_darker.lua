...
function M.setup()
    ...
    c.cursor.style.fg = { Rgb = { 73, 113, 136 } }
    c.default_ui.style.fg = { Rgb = { 100, 92, 84 } }
    c.focus_ui.style = { fg = { Rgb = { 26, 25, 24 } }, bg = { Rgb = { 73, 113, 136 } }, add_modifiers = { "Bold" } }
    c.selection_ui.style = { fg = { Rgb = { 117, 120, 69 } }, add_modifiers = { "Bold" } }
    c.focus_selection_ui.style = { fg = { Rgb = { 26, 25, 24 } }, bg = { Rgb = { 117, 120, 69 } } , add_modifiers = { "Bold" } }
    ...
    c.panel_ui.selection.style.fg = { Rgb = { 117, 120, 69 } }
    c.panel_ui.sort_and_filter.style.fg = { Rgb = { 175, 158, 107 } }
    c.logs.info.style.fg = { Rgb = { 73, 113, 136 } }
    c.logs.success.style.fg = { Rgb = { 117, 120, 69 } }
    c.logs.warning.style.fg = { Rgb = { 175, 158, 107 } }
    c.logs.error.style.fg = { Rgb = { 202, 79, 79 } }

    local n = xplr.config.node_types
    n.directory.style = { fg = { Rgb = { 73, 113, 136 } }, add_modifiers = { "Bold" } }
