...
function M.setup()
    ...
    c.focus_ui.style = { fg = { Rgb = { 26, 30, 37 } }, bg = { Rgb = { 128, 151, 175 } }, add_modifiers = { "Bold" } }
    c.selection_ui.style = { fg = { Rgb = { 151, 171, 134 } }, add_modifiers = { "Bold" } }
    c.focus_selection_ui.style = { fg = { Rgb = { 26, 30, 37 } }, bg = { Rgb = { 151, 171, 134 } } , add_modifiers = { "Bold" } }
    c.table.header.style = { fg = { Rgb = { 103, 113, 133 } }, add_modifiers = { "Bold" } }
    c.table.row.style.fg = { Rgb = { 179, 186, 198 } }
    c.table.tree[1].style.fg = { Rgb = { 50, 57, 70 } }
    c.table.tree[2].style.fg = { Rgb = { 50, 57, 70 } }
    c.table.tree[3].style.fg = { Rgb = { 50, 57, 70 } }
