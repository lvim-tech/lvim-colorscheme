...
function M.setup()
    ...
    c.cursor.style.fg = { Rgb = { 121, 144, 168 } }
    c.default_ui.style.fg = { Rgb = { 179, 186, 198 } }
    c.focus_ui.style = { fg = { Rgb = { 31, 36, 45 } }, bg = { Rgb = { 119, 141, 165 } }, add_modifiers = { "Bold" } }
    ...
    c.table.header.style = { fg = { Rgb = { 126, 141, 171 } }, add_modifiers = { "Bold" } }
    ...
    c.logs.info.style.fg = { Rgb = { 121, 144, 168 } }
    c.logs.success.style.fg = { Rgb = { 135, 153, 120 } }
    c.logs.warning.style.fg = { Rgb = { 195, 168, 112 } }
    c.logs.error.style.fg = { Rgb = { 185, 127, 133 } }

    local n = xplr.config.node_types
    n.directory.style = { fg = { Rgb = { 121, 144, 168 } }, add_modifiers = { "Bold" } }
