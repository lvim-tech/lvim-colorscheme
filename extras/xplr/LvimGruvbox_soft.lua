...
function M.setup()
    ...
    c.focus_ui.style = { fg = { Rgb = { 30, 29, 26 } }, bg = { Rgb = { 66, 114, 139 } }, add_modifiers = { "Bold" } }
    c.selection_ui.style = { fg = { Rgb = { 117, 120, 58 } }, add_modifiers = { "Bold" } }
    c.focus_selection_ui.style = { fg = { Rgb = { 30, 29, 26 } }, bg = { Rgb = { 117, 120, 58 } } , add_modifiers = { "Bold" } }
    c.table.header.style = { fg = { Rgb = { 100, 88, 78 } }, add_modifiers = { "Bold" } }
    c.table.row.style.fg = { Rgb = { 100, 92, 84 } }
    c.table.tree[1].style.fg = { Rgb = { 59, 56, 55 } }
    c.table.tree[2].style.fg = { Rgb = { 59, 56, 55 } }
    c.table.tree[3].style.fg = { Rgb = { 59, 56, 55 } }
