...
require("lvim-colorscheme").setup({
    ...
    terminal = {
        ...
        bright_dim = 20, -- hsluv L points ANSI 15 sits below the foreground (it lands ON blocks)
        block_min = 2.5, -- floor for ANSI 15 on ANSI 8: the dim backs off rather than break this
    },
