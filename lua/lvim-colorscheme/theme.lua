...
function M.setup(config)
    ...
    theme.plugins = {
        ...
        OrgHeadlineLevel2 = { fg = c.color_09, style = "bold" },
        OrgHeadlineLevel3 = { fg = c.color_19, style = "bold" },
        OrgHeadlineLevel4 = { fg = c.color_25, style = "bold" },
        OrgHeadlineLevel5 = { fg = c.color_07, style = "bold" },
        OrgHeadlineLevel6 = { fg = c.color_09, style = "bold" },
        OrgHeadlineLevel7 = { fg = c.color_19, style = "bold" },
