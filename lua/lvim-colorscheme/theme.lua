...
function M.setup(config)
    ...
    theme.plugins = {
        ...
        MasonHeader = { bg = c.bg_statusline, fg = c.color_22, style = "bold" },
        MasonHeaderSecondary = { bg = c.bg_statusline, fg = c.color_07, style = "bold" },
        MasonHighlight = { fg = c.color_07 },
        MasonHighlightBlock = { bg = c.color_07, fg = c.bg_statusline },
        MasonHighlightBlockBold = { bg = c.color_07, fg = c.bg_statusline, style = "bold" },
        MasonHighlightSecondary = { fg = c.color_22 },
        MasonHighlightBlockSecondary = { bg = c.color_22, fg = c.bg_statusline },
        MasonHighlightBlockBoldSecondary = { bg = c.color_22, fg = c.bg_statusline, style = "bold" },
        MasonLink = { bg = c.bg_statusline, fg = c.color_22 },
        MasonMuted = { fg = c.color_17 },
        MasonMutedBlock = { bg = c.bg_statusline, fg = c.color_07 },
        MasonMutedBlockBold = { bg = c.bg_statusline, fg = c.color_07, style = "bold" },
