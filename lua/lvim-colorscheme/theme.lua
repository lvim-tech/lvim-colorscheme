...
M.setup = function(colors)
    ...
    local highlights = {
        ...
        MarkdownDash = { fg = c.red_02 },
        MarkdownCheched = { fg = c.red_02 },
        MarkdownUnCheched = { fg = c.red_02 },
        MarkdownQuote = { fg = c.blue_02 },
        MarkdownTableRow = { fg = c.red_02 },
        MarkdownTableHead = { fg = c.red_02 },
        MarkdownTableFill = { bg = c.bg_statusline },
        MarkdownLink = { fg = c.blue_02 },
        MarkdownInfo = { fg = c.info },
        MarkdownSuccess = { fg = c.success },
        MarkdownHint = { fg = c.hint },
        MarkdownWarn = { fg = c.warning },
        MarkdownError = { fg = c.error },
