...
function M.setup(config)
    ...
    theme.base = {
        ...
        CursorLineNr = { fg = c.color_18 },
        MatchParen = { fg = c.color_20, style = "bold" },
        ModeMsg = { fg = c.color_16, style = "bold" },
        ...
        PmenuSbar = { bg = c.color_21 },
        PmenuThumb = { bg = c.color_04 },
    ...
    theme.plugins = {
        TSNote = { fg = c.color_03, bg = c.info },
        TSWarning = { fg = c.color_03, bg = c.warning },
        TSDanger = { fg = c.color_03, bg = c.error },
        TSConstructor = { fg = c.color_24 },
        TSField = { fg = c.color_08 },
        TSKeyword = { fg = c.color_22, style = config.keywordStyle },
        TSKeywordFunction = { fg = c.color_24, style = config.functionStyle },
        TSLabel = { fg = c.color_13 },
        TSOperator = { fg = c.color_14 },
        TSParameter = { fg = c.color_19 },
        TSProperty = { fg = c.color_08 },
        TSPunctDelimiter = { fg = c.color_14 },
        TSPunctBracket = { fg = c.color_16 },
        TSPunctSpecial = { fg = c.color_14 },
        ...
        NvimTreeNormal = { fg = c.color_23, bg = c.bg_sidebar, style = "bold" },
        NvimTreeNormalNC = { fg = c.color_23, bg = c.bg_sidebar, style = "bold" },
        NvimTreeRootFolder = { fg = c.color_25, style = "bold" },
        NvimTreeGitDirty = { fg = c.git.change },
        NvimTreeGitNew = { fg = c.git.add },
        NvimTreeGitDeleted = { fg = c.git.delete },
        NvimTreeFile = { fg = c.color_25, style = "bold" },
        NvimTreeSpecialFile = { fg = c.color_18, style = "bold" },
        NvimTreeImageFile = { fg = c.color_11, style = "bold" },
        NvimTreeExecFile = { fg = c.color_25, style = "bold" },
        ...
        NvimTreeFolderIcon = { fg = c.color_25 },
        ...
        Sneak = { fg = c.color_02, bg = c.color_24 },
        ...
        CmpDocumentation = { fg = c.color_21, bg = c.bg_float },
        CmpDocumentationBorder = { fg = c.border_highlight, bg = c.bg_float },
        CmpItemAbbr = { fg = c.color_21, bg = c.none },
        CmpItemAbbrDeprecated = { fg = c.color_04, bg = c.none, style = "strikethrough" },
        CmpItemAbbrMatch = { fg = c.color_12, bg = c.none },
        CmpItemAbbrMatchFuzzy = { fg = c.color_12, bg = c.none },
        CmpItemKindDefault = { fg = c.color_16, bg = c.none },
        CmpItemMenu = { fg = c.color_15, bg = c.none },
        CmpItemKindKeyword = { fg = c.color_23, bg = c.none },
        CmpItemKindVariable = { fg = c.color_24, bg = c.none },
        CmpItemKindConstant = { fg = c.color_24, bg = c.none },
        CmpItemKindReference = { fg = c.color_24, bg = c.none },
        CmpItemKindValue = { fg = c.color_24, bg = c.none },
        CmpItemKindFunction = { fg = c.color_13, bg = c.none },
        CmpItemKindMethod = { fg = c.color_13, bg = c.none },
        CmpItemKindConstructor = { fg = c.color_13, bg = c.none },
        CmpItemKindClass = { fg = c.color_20, bg = c.none },
        CmpItemKindInterface = { fg = c.color_20, bg = c.none },
        CmpItemKindStruct = { fg = c.color_20, bg = c.none },
        CmpItemKindEvent = { fg = c.color_20, bg = c.none },
        CmpItemKindEnum = { fg = c.color_20, bg = c.none },
        CmpItemKindUnit = { fg = c.color_20, bg = c.none },
        CmpItemKindModule = { fg = c.color_19, bg = c.none },
        CmpItemKindProperty = { fg = c.color_08, bg = c.none },
        CmpItemKindField = { fg = c.color_08, bg = c.none },
        ...
        CalSaturday = { fg = c.color_25 },
        CalSunday = { fg = c.color_25 },
        OrgTSHeadlineLevel1 = { fg = c.color_07, style = "bold" },
        OrgTSHeadlineLevel2 = { fg = c.color_19, style = "bold" },
        OrgTSHeadlineLevel3 = { fg = c.color_22, style = "bold" },
        OrgTSHeadlineLevel4 = { fg = c.color_25, style = "bold" },
        OrgTSHeadlineLevel5 = { fg = c.color_07, style = "bold" },
        OrgTSHeadlineLevel6 = { fg = c.color_19, style = "bold" },
        OrgTSHeadlineLevel7 = { fg = c.color_22, style = "bold" },
        OrgTSHeadlineLevel8 = { fg = c.color_25, style = "bold" },
        OrgHeadlineLevel1 = { fg = c.color_07, style = "bold" },
        OrgHeadlineLevel2 = { fg = c.color_19, style = "bold" },
        OrgHeadlineLevel3 = { fg = c.color_22, style = "bold" },
        OrgHeadlineLevel4 = { fg = c.color_25, style = "bold" },
        OrgHeadlineLevel5 = { fg = c.color_07, style = "bold" },
        OrgHeadlineLevel6 = { fg = c.color_19, style = "bold" },
        OrgHeadlineLevel7 = { fg = c.color_22, style = "bold" },
        OrgHeadlineLevel8 = { fg = c.color_25, style = "bold" },
        OrgDone = { fg = c.color_19, style = "bold" },
        OrgHalf = { fg = c.color_22, style = "bold" },
        OrgUnDone = { fg = c.color_25, style = "bold" },
