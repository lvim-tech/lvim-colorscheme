...
M.setup = function(colors)
    local c = colors
    local highlights = {
        Boolean = { bg = c.none, fg = c.blue_01 },
        Character = { bg = c.none, fg = c.fg_01 },
        Comment = { bg = c.none, fg = c.fg_03, style = config.styles.comments },
        Conditional = { bg = c.none, fg = c.orange_01 }, -- fix
        Constant = { bg = c.none, fg = c.green_02 },
        Constructor = { bg = c.none, fg = c.teal_01 },
        Danger = { bg = c.error, fg = c.bg_03 },
        Debug = { bg = c.none, fg = c.green_02 }, -- fix
        Define = { bg = c.none, fg = c.blue_01 }, -- fix
        Delimiter = { bg = c.none, fg = c.orange_01 },
        Exception = { bg = c.none, fg = c.green_03 },
        Field = { bg = c.none, fg = c.orange_03 },
        Float = { bg = c.none, fg = c.cyan_02 },
        FuncBuiltin = { bg = c.none, fg = c.green_01 },
        Function = { bg = c.none, fg = c.red_02, style = config.styles.functions },
        Identifier = { bg = c.none, fg = c.green_02, style = config.styles.variables },
        Include = { bg = c.none, fg = c.blue_03 },
        Keyword = { bg = c.none, fg = c.green_01, style = config.styles.keywords },
        KeywordFunction = { bg = c.none, fg = c.cyan_02, style = config.styles.keywords },
        Label = { bg = c.none, fg = c.blue_03 },
        Macro = { bg = c.none, fg = c.teal_01 },
        Note = { bg = c.none, fg = c.color_03 },
        Number = { bg = c.none, fg = c.green_03 },
        Operator = { bg = c.none, fg = c.color_23, style = "bold" },
        Parameter = { bg = c.none, fg = c.fg_06 },
        PreProc = { bg = c.none, fg = c.teal_03 },
        Property = { bg = c.none, fg = c.orange_03 },
        Repeat = { bg = c.none, fg = c.red_01 }, -- fix
        Special = { bg = c.none, fg = c.green_01 },
        SpecialChar = { bg = c.none, fg = c.teal_02 }, -- fix
        SpecialComment = { bg = c.none, fg = c.color_18 }, -- fix
        StorageClass = { bg = c.none, fg = c.red_01 }, -- fix
        String = { bg = c.none, fg = c.fg_04 },
        StringEscape = { bg = c.none, fg = c.orange_02 },
        StringRegex = { bg = c.none, fg = c.blue_03 },
        Structure = { bg = c.none, fg = c.red_02 },
        Tag = { bg = c.none, fg = c.green_01 },
        TextReference = { bg = c.none, fg = c.teal_01 },
        Title = { bg = c.none, fg = c.green_01, style = "bold" },
        Todo = { bg = c.none, fg = c.orange_01 },
        Type = { bg = c.none, fg = c.orange_01 },
        Typedef = { bg = c.none, fg = c.red_03 },
        Variable = { bg = c.none, fg = c.fg_06, style = config.styles.variables },
        VariableBuiltin = { bg = c.none, fg = c.blue_03 },
        Directory = { bg = c.none, fg = c.orange_01 },
        --
        ErrorMsg = { fg = c.error },
