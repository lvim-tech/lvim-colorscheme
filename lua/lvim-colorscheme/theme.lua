...
M.setup = function(colors)
    ...
    local highlights = {
        ...
        --
        RgFlowHead = { bg = colors.bg_statusline, fg = colors.red_02, style = "bold" },
        RgFlowInputBg = { bg = colors.bg_statusline },
        RgFlowHeadLine = { bg = colors.bg_statusline },
        ...
        --
        DiagnosticError = { bg = c.NONE, fg = c.error },
        DiagnosticWarn = { bg = c.NONE, fg = c.warning },
        DiagnosticInfo = { bg = c.NONE, fg = c.info },
        DiagnosticHint = { bg = c.NONE, fg = c.hint },
        ...
        DiagnosticVirtualTextError = { bg = c.NONE, fg = c.error },
        DiagnosticVirtualTextHint = { bg = c.NONE, fg = c.hint },
        DiagnosticVirtualTextInfo = { bg = c.NONE, fg = c.info },
        DiagnosticVirtualTextWarn = { bg = c.NONE, fg = c.warning },
        --
        ...
        RainbowDelimiterOrange = { fg = colors.fg_06 },
        RainbowDelimiterGreen = { fg = colors.green_02 },
        RainbowDelimiterViolet = { fg = colors.fg_07 },
        RainbowDelimiterCyan = { fg = colors.cyan_02 },
        MiniIndentscopeSymbol = { fg = colors.red_02 },
        ...
        ["@neorg.headings.1.prefix"] = { fg = c.blue_01 },
        ["@neorg.headings.1.title"] = { fg = c.blue_01, style = "bold" },
        ["@neorg.headings.2.prefix"] = { fg = c.teal_01 },
        ["@neorg.headings.2.title"] = { fg = c.teal_01, style = "bold" },
        ["@neorg.headings.3.prefix"] = { fg = c.cyan_01 },
        ["@neorg.headings.3.title"] = { fg = c.cyan_01, style = "bold" },
        ["@neorg.headings.4.prefix"] = { fg = c.green_01 },
        ["@neorg.headings.4.title"] = { fg = c.green_01, style = "bold" },
        ["@neorg.headings.5.prefix"] = { fg = c.red_01 },
        ["@neorg.headings.5.title"] = { fg = c.red_01, style = "bold" },
        ["@neorg.headings.6.prefix"] = { fg = c.orange_01 },
        ["@neorg.headings.6.title"] = { fg = c.orange_01, style = "bold" },
        ["@neorg.markup.bold"] = { style = "bold" },
        ["@neorg.markup.italic"] = { italic = true },
        ["@conceal"] = { link = "Conceal", default = true },
        ["@neorg.todo.icon.done"] = { fg = c.green_02 },
        ["@neorg.todo.icon.cancelled"] = { fg = c.green_02 },
        ["@neorg.todo.icon.on_hold"] = { fg = c.green_02 },
        ["@neorg.todo.icon.pending"] = { fg = c.green_02 },
        ["@neorg.todo.icon.recurring"] = { fg = c.green_02 },
