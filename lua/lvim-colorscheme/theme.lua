...
M.setup = function(colors)
    ...
    local highlights = {
        ...
        NoiceFormatProgressTodo = { bg = c.none, fg = c.color_19 },
        NoiceFormatProgressDone = { bg = c.color_19, fg = c.color_01 },
        ...
        SideBar = { bg = c.bg_statusline, fg = c.color_21 },
        SideBarNC = { bg = c.bg_statusline, fg = c.color_21 },
