...
function lvim.load_syntax()
    local syntax = {
        ...
        SignColumn = {fg = lvim.fg, bg = lvim.bg_03},
        FoldColumn = {fg = lvim.color_10, bg = lvim.bg_02},
        VertSplit = {fg = lvim.bg_02, bg = lvim.bg_03},
        Folded = {fg = lvim.color_12, bg = lvim.bg_02},
        EndOfBuffer = {fg = lvim.bg_03, bg = lvim.none},
        ...
        LineNr = {fg = lvim.hl_01, bg = lvim.bg_03},
        qfLineNr = {fg = lvim.color_10, bg = lvim.bg_03},
        CursorLineNr = {fg = lvim.color_10, bg = lvim.bg_03},
...
function lvim.load_plugin_syntax()
    local plugin_syntax = {
        OverwriteNormal = {fg = lvim.fg, bg = lvim.bg_01},
