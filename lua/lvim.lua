...
function lvim.load_syntax()
    local syntax = {
        ...
        StatusLineNC = { fg = lvim.color_10, bg = lvim.bg_02, style = "bold" },
        ...
        Bold = { style = "bold" },
        Italic = { style = "italic" },
        DiagnosticError = { fg = lvim.color_error },
        DiagnosticWarn = { fg = lvim.color_warning },
        DiagnosticInfo = { fg = lvim.color_info },
        DiagnosticHint = { fg = lvim.color_hint },
        UIPrompt = { fg = lvim.bg_03, bg = lvim.color_10 },
        UIPromptSelect = { fg = lvim.bg_03, bg = lvim.color_10, style = "bold" },
        WinBar = { fg = lvim.color_10 },
