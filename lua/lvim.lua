...
function lvim.load_syntax()
    local syntax = {
        ...
        IncSearch = {fg = lvim.bg1, bg = lvim.color_2, style = lvim.none},
        Search = {fg = lvim.bg, bg = lvim.color_2},
        ...
        Comment = {fg = lvim.color_9},
        SpecialComment = {fg = lvim.color_12},
        Todo = {fg = lvim.color_9},
...
function lvim.load_plugin_syntax()
    local plugin_syntax = {
        ...
        VistaChildrenNr = {fg = lvim.color_2},
        VistaKind = {fg = lvim.purpl},
        VistaScope = {fg = lvim.color_0},
        VistaScopeKind = {fg = lvim.color_8},
        VistaTag = {fg = lvim.color_10, style = 'bold'},
        VistaPrefix = {fg = lvim.color_12},
        VistaColon = {fg = lvim.color_10},
