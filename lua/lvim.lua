...
function lvim.load_syntax()
    local syntax = {
        ...
        SignColumn = { fg = lvim.fg, bg = lvim.bg_01 },
        ...
        LineNr = { fg = lvim.hl_01, bg = lvim.bg_01 },
        qfLineNr = { fg = lvim.color_5, bg = lvim.bg_01 },
        CursorLineNr = { fg = lvim.color_5, bg = lvim.bg_01 },
        ...
        Bold = { style = "bold" },
        Italic = { style = "italic" },
        DiagnosticError = { fg = lvim.color_error, bg = lvim.bg_01 },
        DiagnosticWarn = { fg = lvim.color_warning, bg = lvim.bg_01 },
        DiagnosticInfo = { fg = lvim.color_info, bg = lvim.bg_01 },
        DiagnosticHint = { fg = lvim.color_hint, bg = lvim.bg_01 },
...
function lvim.load_plugin_syntax()
    local plugin_syntax = {
        ...
        GitSignsAdd = { fg = lvim.color_add, bg = lvim.bg_01 },
        GitSignsChange = { fg = lvim.color_change, bg = lvim.bg_01 },
        GitSignsDelete = { fg = lvim.color_delete, bg = lvim.bg_01 },
        GitSignsAddNr = { fg = lvim.color_add, bg = lvim.bg_01 },
        GitSignsChangeNr = { fg = lvim.color_change, bg = lvim.bg_01 },
        GitSignsDeleteNr = { fg = lvim.color_delete, bg = lvim.bg_01 },
        GitSignsAddLn = { fg = lvim.color_add, bg = lvim.bg_01 },
        GitSignsChangeLn = { fg = lvim.color_change, bg = lvim.bg_01 },
        GitSignsDeleteLn = { fg = lvim.color_delete, bg = lvim.bg_01 },
